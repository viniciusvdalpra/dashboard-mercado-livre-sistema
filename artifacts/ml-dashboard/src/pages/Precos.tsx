  ...
  return (
    <Layout>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <KpiCard label="Abaixo do mínimo" value={belowCount} icon={<TrendingDown className="h-4 w-4" />} trend={{ value: 5.1, isPositive: false }} onClick={() => { setActiveFilter("below_min"); setPage(1); }} variant={belowCount > 0 ? "alert" : "default"} />
        <KpiCard label="Acima do máximo" value={aboveCount} icon={<TrendingUp className="h-4 w-4" />} onClick={() => { setActiveFilter("above_max"); setPage(1); }} variant={aboveCount > 0 ? "warn" : "default"} />
