  ...
  return (
    <Layout>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <KpiCard label="Total" value={counts.all} icon={<Wrench className="h-4 w-4" />} />
        <KpiCard label="Pendentes" value={counts.pending} icon={<Clock className="h-4 w-4" />} />
        <KpiCard label="Aprovadas" value={counts.approved} icon={<CheckCircle className="h-4 w-4" />} />
        <KpiCard accent label="Aplicadas" value={counts.applied} icon={<Check className="h-4 w-4" />} />
      </div>
